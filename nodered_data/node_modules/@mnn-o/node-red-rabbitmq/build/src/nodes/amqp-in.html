...
<script type="text/html" data-template-name="amqp-in">
  ...
  <div class="form-tips">
    ...
    If noAck is unchecked here the message will be acked upon successfull receipt <em>before</em> it is sent through the output. If you need more control over when the ack is sent use the <strong>amqp-in-manual-ack</strong> node instead.
  </div>
  <hr>
  <h4>Exchange Info</h4>
  ...
  <div class="form-row wide-label-amqp-in">
    <label for="node-input-exchangeName" style="width: 30%"><i class="fa fa-tag"></i>&nbsp;&nbsp;Exchange Name</label>
  ...
  <div class="form-row wide-label-amqp-in headers-form-input">
